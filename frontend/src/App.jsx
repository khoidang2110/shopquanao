...
function App() {
  ...
  return (
    <div className="app">
      ...
      {showNewsAPI && <NewsAPI onClose={() => setShowNewsAPI(false)} />}

      <footer className="footer">
        <button className="news-btn" onClick={() => setShowNews(true)}>
          Tin tức (Local)
        </button>
        <button className="news-btn" onClick={() => setShowNewsAPI(true)}>
          Tin tức (API)
        </button>
      </footer>
    </div>
