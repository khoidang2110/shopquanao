...
// Middleware
// Allow configuring allowed frontend origins via FRONTEND_URLS env var (comma-separated)
...
// Fallback default origins for local/dev if FRONTEND_URLS is not set
if (allowedOrigins.length === 0) {
  allowedOrigins.push('http://localhost:5173', 'http://andynguyen03006.ddns.net:5173');
}
